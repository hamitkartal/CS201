...
int atoi(const string & s);         // returns int equivalent      // string --> int
double atof(const string & s);      // returns double equivalent   // string ---> double
string itoa(int n);                 // returns string equivalent    // int ----> string
string tostring(int n);             // like itoa, convert int to string  // int ---> string
string tostring(double d);          // convert double to string  // double ----> string
